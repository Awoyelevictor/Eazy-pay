    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="p-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight">FyreVTU</span>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-4xl mx-auto">
        <div className="relative w-full aspect-video rounded-3xl overflow-hidden shadow-2xl mb-8 group">
          <Image 
            src="https://picsum.photos/seed/fyrevtu-hero/1200/600" 
            alt="FyreVTU Dashboard" 
            fill
        ...
        <h1 className="text-4xl sm:text-6xl font-black text-foreground mb-4 leading-tight">
          Reliable Top-ups <span className="text-primary">Instant</span> Delivery.
        </h1>
        <p className="text-muted-foreground text-lg mb-8 max-w-2xl">
          The fastest way to manage your airtime, data, and utility bills. 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 w-full text-left">
          {[
            { icon: Smartphone, title: "Swift Top-up", desc: "Airtime and data sent in milliseconds." },
            { icon: ShieldCheck, title: "Bank Grade Security", desc: "Your funds are protected with multi-layer encryption." },
      ...
      <footer className="p-8 text-center text-sm text-muted-foreground">
        © 2024 FyreVTU. All rights reserved.
      </footer>
    </div>
  );
}
